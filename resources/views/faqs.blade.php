                ...
                <div class="table-responsive">
                    <table class="table ps-table--faqs">
                        <tbody>
                            ...
                            <tr>
                                <td class="question">¿Hacen envíos internacionales?</td>
                                <td>Hoodie tote bag mixtape tofu. Typewriter jean shorts wolf quinoa, messenger bag organic freegan cray.</td>
                            </tr>
                            <tr>
                                <td class="question">¿Cuánto tiempo tomará obtener mi paquete?</td>
                            ...
                            <tr>
                                <td class="question">¿Cómo hago un seguimiento de mi pedido?</td>
