...
<head>
 ...
 ======================================-->
    ...
    <!-- google font -->
    <link
        href="{{ URL::asset('https://fonts.googleapis.com/css?family=Work+Sans:300,400,500,600,700&display=swap') }}"
        rel="stylesheet">
    ...
    <!-- Bootstrap 4 -->
    <link rel="stylesheet"
        href="{{ URL::asset('https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css') }}">
     ...
     ======================================-->
                    ...
                    <div class="menu--product-categories">
                        ...
                        <div class="menu__toggle">
                            <i class="icon-menu"></i>
                            <span style="font-size:0.5vw; min-width: 80%;"> Categorias de productos</span>
                        </div>

                        <div class="menu__content">
                            <ul class="menu--dropdown">
                                <li class="menu-item-has-children has-mega-menu">
                                    <a href="{{ URL::asset('#') }}"><i class="fas fa-apple-alt"></i> Frutas</a>
                                    <div class="mega-menu">
                                        <div class="mega-menu__column">
                                            <h4>Frutas ácidas<span class="sub-toggle"></span></h4>
                                            <ul class="mega-menu__list">
                                                <li><a href="{{ URL::asset('#') }}">Kiwis</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Limónes</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Pomelos</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Naranjas</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Manzanas</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Uvas</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Piñas</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="mega-menu__column">
                                            <h4>Frutas semiácidas<span class="sub-toggle"></span></h4>
                                            <ul class="mega-menu__list">
                                                <li><a href="{{ URL::asset('#') }}">Fresas</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Melocotón</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Mango</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Mandarina</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="mega-menu__column">
                                            <h4>Frutas neutras<span class="sub-toggle"></span></h4>
                                            <ul class="mega-menu__list">
                                                <li><a href="{{ URL::asset('#') }}">Cocos</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Nuez</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Almendra</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="mega-menu__column">
                                            <h4>Frutas dulces<span class="sub-toggle"></span></h4>
                                            <ul class="mega-menu__list">
                                                <li><a href="{{ URL::asset('#') }}">Bananos</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Cereza</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Melón</a>
                                                </li>
                                            </ul>
                                        </div>
                                        {{-- <div class="mega-menu__column">
                                ...
                                <li class="menu-item-has-children has-mega-menu">
                                    <a href="{{ URL::asset('#') }}"><i class="fas fa-carrot"></i> Vegetales</a>
                                    <div class="mega-menu">
                                        <div class="mega-menu__column">
                                            <h4>Raiz<span class="sub-toggle"></span></h4>
                                            <ul class="mega-menu__list">
                                                <li><a href="{{ URL::asset('#') }}">Zanahorias</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Rábanos</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Nabos</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="mega-menu__column">
                                            <h4>Bulbo<span class="sub-toggle"></span></h4>
                                            <ul class="mega-menu__list">
                                                <li><a href="{{ URL::asset('#') }}">Cebollas</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Ajos</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Remolachas</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="mega-menu__column">
                                            <h4>Tallo<span class="sub-toggle"></span></h4>
                                            <ul class="mega-menu__list">
                                                <li><a href="{{ URL::asset('#') }}">Espárragos</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Puerros</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Apios</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="mega-menu__column">
                                            <h4>Hoja<span class="sub-toggle"></span></h4>
                                            <ul class="mega-menu__list">
                                                <li><a href="{{ URL::asset('#') }}">Espinacas</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Rúculas</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Lechugas</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="mega-menu__column">
                                            <h4>Flor<span class="sub-toggle"></span></h4>
                                            <ul class="mega-menu__list">
                                                <li><a href="{{ URL::asset('#') }}">Coliflores</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Brócolis</a>
                                                </li>
                                                <li><a href="{{ URL::asset('#') }}">Alcachofas</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
    ...
    ======================================-->
                ...
                <div class="header__content-center">
                    <form class="ps-form--quick-search" action="index.html" method="get">
                        ...
                        <input class="form-control" type="text" placeholder="Quiero buscar...">
                        ...
                        <div class="ps-cart--mini">
                            ...
                            <div class="ps-cart__content">
                                ...
                                <div class="ps-cart__items">
                                    ...
                                    <div class="ps-product--cart-mobile">
                                        ...
                                        <div class="ps-product__thumbnail">
                                            <a href="{{ URL::asset('#') }}">
                                                <img src="{{ URL::asset('img/products/clothing/a_1_1.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        ...
                                        <div class="ps-product__content">
                                            ...
                                            <a href="{{ URL::asset('product-default.html') }}">Coco x12 UD</a>
                                            <p><strong>Vendido por:</strong> COCOLERIOS S.A</p>
                                            <small>1 x $20.000</small>
                                        </div>
                                    ...
                                    <div class="ps-product--cart-mobile">
                                        ...
                                        <div class="ps-product__thumbnail">
                                            <a href="{{ URL::asset('#') }}">
                                                <img src="{{ URL::asset('img/products/clothing/b_1_3.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        ...
                                        <div class="ps-product__content">
                                            ...
                                            <a href="{{ URL::asset('product-default.html') }}">Caja de bananos x8 UD</a>
                                            <p><strong>Vendido por:</strong>LA PLATANERIA</p>
                                            <small>1 x $20.000</small>
                                        </div>
                                ...
                                <div class="ps-cart__footer">
                                    ...
                                    <h3>Sub Total:<strong>$40.000</strong></h3>
                                    <figure>
                                        <a class="ps-btn" href="{{ route('shopping-car') }}">Ver carrito</a>
                                        <a class="ps-btn" href="{{ route('checkout') }}">Pagar</a>
                                    </figure>
                            ...
                            <aside class="widget widget_shop">
                                ...
                                <ul class="ps-list--categories">
                                    <li class="current-menu-item menu-item-has-children"><a
                                            href="shop-default.html">Clothing &amp; Apparel</a><span
                                        ...
                                        <ul class="sub-menu" style="display: none;">
                                            ...
                                            <li class="current-menu-item "><a href="shop-default.html">Kid's
                                                    Fashion</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="current-menu-item menu-item-has-children"><a
                                            href="shop-default.html">Garden &amp; Kitchen</a><span
                                        ...
                                        <ul class="sub-menu" style="display: block;">
                                            ...
                                            <li class="current-menu-item "><a href="shop-default.html">Home
                                                    Improvement</a>
                                            </li>
                                            <li class="current-menu-item "><a href="shop-default.html">Powers And Hand
                                                    Tools</a>
                                            </li>
                                            <li class="current-menu-item "><a href="shop-default.html">Utensil &amp;
                                                    Gadget</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="current-menu-item menu-item-has-children"><a
                                            href="shop-default.html">Consumer Electrics</a><span
                                            class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                                        <ul class="sub-menu" style="">
                                            <li class="current-menu-item menu-item-has-children"><a
                                                    href="shop-default.html">Air Conditioners</a><span
                                                    class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                                                <ul class="sub-menu" style="">
                                                    <li class="current-menu-item "><a
                                                            href="shop-default.html">Accessories</a>
                                                    </li>
                                                    <li class="current-menu-item "><a href="shop-default.html">Type
                                                            Hanging Cell</a>
                                                    </li>
                                                    <li class="current-menu-item "><a href="shop-default.html">Type
                                                            Hanging Wall</a>
                                            ...
                                            <li class="current-menu-item menu-item-has-children"><a
                                                    href="shop-default.html">Audios &amp; Theaters</a><span
                                                    class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                                                <ul class="sub-menu" style="">
                                                    <li class="current-menu-item "><a
                                                            href="shop-default.html">Headphone</a>
                                                    </li>
                                                    <li class="current-menu-item "><a href="shop-default.html">Home
                                                            Theater System</a>
                                                    </li>
                                                    <li class="current-menu-item "><a
                                                            href="shop-default.html">Speakers</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="current-menu-item menu-item-has-children"><a
                                                    href="shop-default.html">Car Electronics</a><span
                                                    class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                                                <ul class="sub-menu" style="">
                                                    <li class="current-menu-item "><a href="shop-default.html">Audio
                                                            &amp; Video</a>
                                                    </li>
                                                    <li class="current-menu-item "><a href="shop-default.html">Car
                                                            Security</a>
                                                    </li>
                                                    <li class="current-menu-item "><a href="shop-default.html">Radar
                                                            Detector</a>
                                                    </li>
                                                    <li class="current-menu-item "><a href="shop-default.html">Vehicle
                                                            GPS</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="current-menu-item menu-item-has-children"><a
                                                    href="shop-default.html">Office Electronics</a><span
                                                    class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                                                <ul class="sub-menu" style="">
                                                    <li class="current-menu-item "><a
                                                            href="shop-default.html">Printers</a>
                                                    </li>
                                                    <li class="current-menu-item "><a
                                                            href="shop-default.html">Projectors</a>
                                                    </li>
                                                    <li class="current-menu-item "><a
                                                            href="shop-default.html">Scanners</a>
                                                    </li>
                                                    <li class="current-menu-item "><a href="shop-default.html">Store
                                                            &amp; Business</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="current-menu-item menu-item-has-children"><a
                                                    href="shop-default.html">TV Televisions</a><span
                                                    class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                                                <ul class="sub-menu" style="">
                                                    <li class="current-menu-item "><a href="shop-default.html">4K Ultra
                                                            HD TVs</a>
                                                    </li>
                                                    <li class="current-menu-item "><a href="shop-default.html">LED
                                                            TVs</a>
                                                    </li>
                                                    <li class="current-menu-item "><a href="shop-default.html">OLED
                                                            TVs</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="current-menu-item menu-item-has-children"><a
                                                    href="shop-default.html">Washing Machines</a><span
                                                    class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                                                <ul class="sub-menu" style="">
                                                    <li class="current-menu-item "><a href="shop-default.html">Type
                                                            Drying Clothes</a>
                                            ...
                                            <li class="current-menu-item "><a
                                                    href="shop-default.html">Refrigerators</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="current-menu-item menu-item-has-children"><a
                                            href="shop-default.html">Health &amp; Beauty</a><span
                                            class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                                        <ul class="sub-menu" style="">
                                    ...
                                    <li class="current-menu-item menu-item-has-children"><a
                                            href="shop-default.html">Computers &amp; Technologies</a><span
                                            class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                                        <ul class="sub-menu" style="">
                                    ...
                                    <li class="current-menu-item menu-item-has-children"><a
                                            href="shop-default.html">Jewelry &amp; Watches</a><span
                                            class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                                        <ul class="sub-menu" style="">
                                            <li class="current-menu-item "><a href="shop-default.html">Gemstone
                                                    Jewelry</a>
                                            </li>
                                            <li class="current-menu-item "><a href="shop-default.html">Men's
                                                    Watches</a>
                                            </li>
                                            <li class="current-menu-item "><a href="shop-default.html">Women's
                                                    Watches</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="current-menu-item menu-item-has-children"><a
                                            href="shop-default.html">Phones &amp; Accessories</a><span
                                            class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                                        <ul class="sub-menu" style="">
                                            ...
                                            <li class="current-menu-item "><a href="shop-default.html">Sam Sung Note
                                                    8</a>
                                            </li>
                                    ...
                                    <li class="current-menu-item menu-item-has-children"><a
                                            href="shop-default.html">Sport &amp; Outdoor</a><span
                                            class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                                        <ul class="sub-menu" style="">
                                            <li class="current-menu-item "><a href="shop-default.html">Freezer Burn</a>
                                            </li>
                                            <li class="current-menu-item "><a href="shop-default.html">Fridge
                                                    Cooler</a>
                                            </li>
                                            <li class="current-menu-item "><a href="shop-default.html">Wine
                                                    Cabinets</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="current-menu-item "><a href="shop-default.html">Cars &amp;
                                            Motocycles</a>
                                    </li>
                                </ul>
                    ...
                    <div class="mega-menu">
                        <div class="mega-menu__column">
                            ...
                            <ul class="mega-menu__list">
                                ...
                                <li class="current-menu-item "><a href="shop-sidebar-without-banner.html">Shop Without
                                        Banner</a>
                                </li>
